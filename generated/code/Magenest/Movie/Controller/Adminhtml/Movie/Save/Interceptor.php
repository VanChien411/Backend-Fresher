...
class Interceptor extends \Magenest\Movie\Controller\Adminhtml\Movie\Save implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magenest\Movie\Model\MovieFactory $movieFactory)
    {
        $this->___init();
        parent::__construct($context, $movieFactory);
    }
